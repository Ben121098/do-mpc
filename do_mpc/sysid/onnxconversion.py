...
class ONNXConversion:
    ...
    **Example:**
    ...
    We start with a simple Keras model 
    ::
...
class Operations:
    ...
    def Tanh(self,x, attribute = None):
        ...
        See `ONNX documentation <https://github.com/onnx/onnx/blob/main/docs/Operators.md#Tanh>`_ for more details.
        """
        return casadi.tanh(x)

    def Sigmoid(self,x, attribute = None):
        """Sigmoid activation function.
        See `ONNX documentation <https://github.com/onnx/onnx/blob/main/docs/Operators.md#Sigmoid>`_ for more details.
        """
    ...
    def Relu(self,x, attribute = None):
        ...
        See `ONNX documentation <https://github.com/onnx/onnx/blob/main/docs/Operators.md#Relu>`_ for more details.
        """
        return casadi.fmax(0,x)

    def Elu(self,x, attribute = None):
        """Relu activation function.
        See `ONNX documentation <https://github.com/onnx/onnx/blob/main/docs/Operators.md#Elu>`_ for more details.
        """
        return casadi.fmax(0,x) + casadi.fmin(0,casadi.exp(x)-1)

    def MatMul(self,*args, attribute = None):
        """Weight matrix vector multiplication.
        See `ONNX documentation <https://github.com/onnx/onnx/blob/main/docs/Operators.md#MatMul>`_ for more details.
        """
    ...
    def Sum(self,*args, attribute = None):
        ...
        See `ONNX documentation <https://github.com/onnx/onnx/blob/main/docs/Operators.md#Sum>`_ for more details.
        """
        return  self.Add(*args)

    def Concat(self,*args, attribute = None):
        """Concatination of two layers.
    ...
    def Unsqueeze(self,*args, attribute = None):
        """Shape correction between two layers.
